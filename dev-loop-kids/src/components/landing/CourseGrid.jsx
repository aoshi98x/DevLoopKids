...
// Definimos un mapa de colores que Tailwind pueda escanear
const colorVariants = {
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {courses.map((course) => (
              <div 
                key={course.id} 
                // Usamos el colorVariants para obtener la clase segura
              ...
              >
                ...
                <button className="mt-6 w-full py-3 bg-white/60 hover:bg-white rounded-full font-bold text-gray-800 transition-colors shadow-sm">
                  Explorar Curso
                </button>
              </div>
            ))}
